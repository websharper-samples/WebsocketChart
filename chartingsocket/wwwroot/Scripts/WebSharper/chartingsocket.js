...
{
 "use strict";
 var chartingsocket,Client,WebSharper,UI,Var$1,Submitter,View,Remoting,AjaxRemotingProvider,Concurrency,Doc,AttrProxy;
 chartingsocket=Global.chartingsocket=Global.chartingsocket||{};
 Client=chartingsocket.Client=chartingsocket.Client||{};
 ...
 Client.Main=function()
 {
  ...
  {
   var b;
   return a!=null&&a.$==1?(new AjaxRemotingProvider.New()).Async("chartingsocket:chartingsocket.Server.DoSomething:133784537",[a.$0]):(b=null,Concurrency.Delay(function()
   {
